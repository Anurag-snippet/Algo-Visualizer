...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-dB_wyuR4.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Be_vb8VO.js"),
    import("./start-B4wZMsYS.js"),
...
var ROUTER_BASEPATH = "Algo-Visualizer";
var SERVER_FN_BASE = "/Algo-Visualizer/_serverFn/";
